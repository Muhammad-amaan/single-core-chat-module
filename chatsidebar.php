<aside class="control-sidebar control-sidebar-dark" style="position: fixed; min-height: 100%;">
    <!-- Create the tabs -->
    ...
    <div class="tab-content">
      ...
      <div class="tab-pane active" id="control-sidebar-home-tab">
        ...
        <ul class="control-sidebar-menu onlineusers">
    
         <!--  <li class="usersli">
            <a href="javascript:register_popup('1', 'maan');">
              
              <img src="" class="img-avatar" />
              <div class="menu-info">
                <h4 class="control-sidebar-subheading">Langdon's Birthday</h4>

                <p>Lives in karachi</p>
              </div>
            </a>
          </li> -->
        </ul>
  ...
  <div class="msg_box" chat-id="" style="">
  <div class="msg_head"><div class="chattingwith">Krishna Teja</div>
  ...
  <div class="msg_footer">
    <input type="hidden" id="send_class" name="send_class" sender-class="msg_text_sender" />
    <input type="hidden" id="receiver_class" name="receiver_class" receiver-class="msg_text_receiver" />
    <input type="text" class="msg_input" /></div>
    <!--<div class="chat-options"><div class="pull-left"><a href=""><i class="fa fa-camera"></i></a></div> <div class="pull-right">Like</div></div>-->
</div>
</div>